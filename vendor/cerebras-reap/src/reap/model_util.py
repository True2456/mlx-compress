...
MODEL_ATTRS = {
    ...
    # MiniMax-M2 / M2.7: Mixtral-like MoE layout with sigmoid + e_score_correction_bias routing.
    # Expert SwiGLU uses w1 (gate), w3 (up), w2 (down).
    ...
    # Step-3.7-Flash / Step-3.5: MoE layout with sigmoid router + router_bias
